...
class HomePageService extends GetxService {
  ...
  //data quan trắc
  RxDouble pH1 = 7.3.obs;
  RxDouble temp1 = 24.8.obs;
  RxDouble cod = 508.0.obs;
  RxDouble bod = 0.2.obs;
  RxDouble tss = 0.2.obs;
  RxDouble pH2 = 7.1.obs;
  RxDouble temp2 = 23.5.obs;
  RxDouble temp3 = 24.1.obs;
  RxDouble do1 = 0.4.obs;
  RxDouble do2 = 3.6.obs;
